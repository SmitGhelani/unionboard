...
exports.signup = BigPromise(async (req, res, next) => {
    ...
    // Generate url --> https://unionboard-backend.smitghelani.xyz:4000/activateEmail/{activation_token}
...
exports.forgotPassword = BigPromise(async (req, res, next) => {
    ...
    // Create URL ---> https://unionboard-backend.smitghelani.xyz:4000/password/reset/{token}
...
exports.resetPassword = BigPromise(async (req, res, next) => {
    ...
    // Get token from params ---> https://unionboard-backend.smitghelani.xyz:4000/password/reset/{token}
